...
export function showBlockOverlay(result) {
    if (overlayElement) {
        return;
    }
    ...
    title.setAttribute("style", "margin: 0 0 16px; font-size: 24px; font-weight: 600;");
    ...
    status.setAttribute("style", "margin: 0 0 16px; font-size: 14px; color: #9ca3af;");
    const reasonsHeading = document.createElement("h2");
    reasonsHeading.textContent = "Why we blocked this page";
    reasonsHeading.setAttribute("style", "margin: 0 0 12px; font-size: 18px; font-weight: 600;");
    const reasonsList = document.createElement("ul");
    reasonsList.setAttribute("style", [
        "margin: 0 0 16px",
        "padding-left: 20px",
        "text-align: left",
        "line-height: 1.5"
    ...
    hint.setAttribute("style", "margin: 0; font-size: 13px; color: #d1d5db; line-height: 1.4;");
